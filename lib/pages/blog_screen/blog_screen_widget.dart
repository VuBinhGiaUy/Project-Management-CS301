...
import 'blog_screen_model.dart';
export 'blog_screen_model.dart';

class BlogScreenWidget extends StatefulWidget {
  const BlogScreenWidget({Key? key}) : super(key: key);
...
class _BlogScreenWidgetState extends State<BlogScreenWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BlogScreenModel());
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              FFLocalizations.of(context).getText(
                                'xme46bxo' /* Find some wonderful little cab... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText:
                                        FFLocalizations.of(context).getText(
                                      '1tziau26' /* Search for your destination... */,
                                    ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: AutoSizeText(
                                  FFLocalizations.of(context).getText(
                                    'jh8keo1y' /* Retreat to the natural beauty ... */,
                                  ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    '107puvyg' /* Little Mountain House */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .headlineSmall
                                      .override(
                              ...
                              Padding(
                                ...
                                child: AutoSizeText(
                                  FFLocalizations.of(context).getText(
                                    'edu5e5wq' /* Escape to the serene beauty of... */,
                                  ),
                                  textAlign: TextAlign.start,
                                  style: FlutterFlowTheme.of(context)
                                      .labelMedium
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: AutoSizeText(
                                  FFLocalizations.of(context).getText(
                                    'pax44ozv' /* Escape to the serene beauty of... */,
                                  ),
                                  textAlign: TextAlign.start,
                                  style: FlutterFlowTheme.of(context)
                                      .labelMedium
